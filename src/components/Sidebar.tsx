...
//       <img src="/images/logo.png" className='mx-auto w-16' alt="" />
...
//             router.push('/');
//           }}
//           className="flex items-center w-full px-4 py-2 mt-6 text-sm font-medium text-red-600 hover:bg-red-50 rounded-lg transition"
//         >
...
const navLinks = [
  ...
  { label: 'Events', icon: Calendar, path: '/events' },
  { label: 'Community', icon: Users, path: '/community' },
  { label: 'Partnerships', icon: Handshake, path: '/partnership' }, // New Link Added
  { label: 'Blogs', icon: Newspaper, path: '/blogs' },
  { label: 'Career', icon: Briefcase, path: '/career' },
];
